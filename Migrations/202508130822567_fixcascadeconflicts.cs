namespace MZDNETWORK.Migrations
{
    ...
    public partial class fixcascadeconflicts : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Description = c.String(maxLength: 200),
                        ColorCode = c.String(maxLength: 30),
                ...
                c => new
                    {
                        ...
                        UserId = c.Int(nullable: false),
                        ServiceCode = c.String(nullable: false, maxLength: 50),
                        ShiftType = c.String(nullable: false, maxLength: 20),
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.ServiceConfigurations", new[] { "ServiceCode" });
