    ...
    public partial class Test : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ...
                        CurrentRolesJson = c.String(),
                        RequestedRolesJson = c.String(),
                        CurrentPermissionsJson = c.String(),
                        RequestedPermissionsJson = c.String(),
                        CurrentUserInfoJson = c.String(),
                        RequestedUserInfoJson = c.String(),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Users", t => t.RequesterUserId)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        GonderiId = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Gonderis", t => t.GonderiId, cascadeDelete: true)
                .Index(t => t.GonderiId);
                ...
                c => new
                    {
                        ...
                        ResponsiblePerson = c.String(maxLength: 500),
                        DueDate = c.DateTime(),
                        Status = c.Int(nullable: false),
                        OrderIndex = c.Int(nullable: false),
                        CreatedByUserId = c.Int(nullable: false),
                        CreatedByUserName = c.String(maxLength: 200),
                        CreatedAt = c.DateTime(nullable: false),
                        UpdatedAt = c.DateTime(),
                ...
                c => new
                    {
                        ...
                        ColorCode = c.String(maxLength: 50),
                        IsActive = c.Boolean(nullable: false),
                        OrderIndex = c.Int(nullable: false),
                        CreatedAt = c.DateTime(nullable: false),
                        UpdatedAt = c.DateTime(),
                ...
                c => new
                    {
                        ...
                        HasDeclined = c.Boolean(nullable: false),
            ...
            CreateTable(
                "dbo.OvertimeServicePersonnels",
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        UserId = c.Int(nullable: false),
                        ServiceConfigurationId = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ServiceConfigurations", t => t.ServiceConfigurationId)
                .ForeignKey("dbo.Users", t => t.UserId)
                .Index(t => t.UserId)
                .Index(t => t.ServiceConfigurationId);
                ...
                c => new
                    {
                        ...
                        Description = c.String(maxLength: 500),
                        VehiclePlate = c.String(maxLength: 100),
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Title = c.String(nullable: false, maxLength: 200),
                        KmlPath = c.String(maxLength: 500),
                        Description = c.String(maxLength: 1000),
                        IsActive = c.Boolean(nullable: false),
                        CreatedDate = c.DateTime(nullable: false),
                        UpdatedDate = c.DateTime(),
                ...
                c => new
                    {
                        ...
                        SignaturePath = c.String(),
                        Approved = c.Boolean(nullable: false),
                        ArrivalReason = c.String(maxLength: 100),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.OvertimeServicePersonnels", "UserId", "dbo.Users");
            DropForeignKey("dbo.OvertimeServicePersonnels", "ServiceConfigurationId", "dbo.ServiceConfigurations");
            DropForeignKey("dbo.ServicePersonnels", "UserId", "dbo.Users");
            DropForeignKey("dbo.ServicePersonnels", "ServiceConfigurationId", "dbo.ServiceConfigurations");
            ...
            DropForeignKey("dbo.MeetingReminderLogs", "ReservationId", "dbo.Reservations");
            DropForeignKey("dbo.MeetingActions", "ReservationId", "dbo.Reservations");
            ...
            DropForeignKey("dbo.Reservations", "MeetingRoom_Id", "dbo.MeetingRooms");
            ...
            DropForeignKey("dbo.GonderiEks", "GonderiId", "dbo.Gonderis");
            ...
            DropForeignKey("dbo.AccessChangeTickets", "TargetUserId", "dbo.Users");
            DropForeignKey("dbo.AccessChangeTickets", "RequesterUserId", "dbo.Users");
            ...
            DropIndex("dbo.ServicePersonnels", new[] { "ServiceConfigurationId" });
            DropIndex("dbo.ServicePersonnels", new[] { "UserId" });
            DropIndex("dbo.ServiceConfigurations", new[] { "ServiceName" });
            DropIndex("dbo.OvertimeServicePersonnels", new[] { "ServiceConfigurationId" });
            DropIndex("dbo.OvertimeServicePersonnels", new[] { "UserId" });
            DropIndex("dbo.MeetingRoomReservations", new[] { "ApprovedBy" });
            DropIndex("dbo.MeetingRoomReservations", new[] { "UserId" });
            DropIndex("dbo.MeetingReminderLogs", new[] { "ReservationId" });
            ...
            DropIndex("dbo.Reservations", new[] { "MeetingRoom_Id" });
            DropIndex("dbo.MeetingActions", new[] { "ReservationId" });
            DropIndex("dbo.LeaveRequests", new[] { "ApprovedById" });
            DropIndex("dbo.LeaveRequests", new[] { "UserId" });
            DropIndex("dbo.GonderiEks", new[] { "GonderiId" });
            ...
            DropIndex("dbo.AccessChangeTickets", new[] { "TargetUserId" });
            DropIndex("dbo.AccessChangeTickets", new[] { "RequesterUserId" });
            ...
            DropTable("dbo.OvertimeServicePersonnels");
            DropTable("dbo.Notifications");
            DropTable("dbo.MeetingRoomReservations");
            DropTable("dbo.MeetingReminderLogs");
            DropTable("dbo.ReservationAttendees");
            DropTable("dbo.MeetingRooms");
            DropTable("dbo.MeetingDecisions");
            DropTable("dbo.Reservations");
            DropTable("dbo.MeetingActions");
            DropTable("dbo.LeaveRequests");
            DropTable("dbo.LateArrivalReports");
            DropTable("dbo.LateArrivalReportHeaders");
            DropTable("dbo.Gonderis");
            DropTable("dbo.GonderiEks");
            ...
            DropTable("dbo.Tasks");
            DropTable("dbo.Users");
            DropTable("dbo.AccessChangeTickets");
        }
    }
}
