...
namespace MZDNETWORK.Controllers
{
    ...
    public class NotificationController : Controller
    {
        ...
        public ActionResult SendNotification(string message, int duration = 4000, string color = "info", bool playSound = false, string sound = null)
        {
            ...
            Logger.Info($"SignalR showNotification broadcasted. Color={color}, Duration={duration}, PlaySound={playSound}");
            return new HttpStatusCodeResult(200);
        }

        [HttpGet]
        [AllowAnonymous]
        public ActionResult TestBroadcast()
        {
            _hubContext.Clients.All.showNotification("Test yayını", 3000, "info", false, null);
            return Content("OK");
        }
